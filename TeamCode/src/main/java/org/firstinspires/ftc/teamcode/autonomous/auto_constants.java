...
public interface auto_constants {
    ...
    public static final Pose2d RED_RIGHT_LEFT_SPIKE = new Pose2d(34.3, 9.35, Math.toRadians(270));
    public static final Pose2d RED_RIGHT_CENTER_SPIKE = new Pose2d(26, 20, Math.toRadians(270));
    ...
    public static final Pose2d RED_CENTER_DROP = new Pose2d(36.5, 53, Math.toRadians(270));
